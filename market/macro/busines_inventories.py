...
class InventoriesSalesRatio:
    ...
    def descr():
        return  """기업 재고
                    미국의 총 기업 매출과 총 재고 측정

                    시장 민감도: 낮음 ~ 중간

                    채권 시장
                    재고의 증가가 GDP의 증가로 이어지고 이자율상승에 압력을 가할 수 있다.
                    재고투자의 감소는 생산량의 감소를 의미 하는데, 이것은 채권 시장에 긍정적이다.
    ...
    @staticmethod
    def retailers_descr():
        return """소매업 재고,Retailers: Inventories to Sales Ratio
