...
class IndustrialProduction:
    ...
    def capacityUtilization_Manufacturing_Computers(mode='binary'):
        return (PlotEconomicIdx('CAPUTLG3341S').renameColumn('컴퓨터와 주변기기 산업 가동률')
                        .plot(title='컴퓨터와 주변기기 산업 가동률', mode=mode, y1_title=''))
    @staticmethod
